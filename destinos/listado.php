<?php
    ...
    $query = 'SELECT id_destino, ciudad, cobertura FROM Destino ORDER BY id_destino';
...
<?php
    ...
    echo '<a class="button" href="agregar.php">Agregar destino</a>';
    echo '<div class="tabla"><table>';
    echo '<tr><th scope="col">ID del destino</th>';
    echo '    <th scope="col">Ciudad</th>';
    echo '    <th scope="col">Cobertura</th>';
    echo '    <th>Acciones</th></tr>';
    while ($fila = pg_fetch_assoc($result)) {
        echo '<tr>';
        echo '<td>' . $fila['id_destino'] . '</td>';
        echo '<td>' . $fila['ciudad'] . '</td>';
        echo '<td>' . $fila['cobertura'] . '</td>';
        echo '<td>';
        echo '<a href="editar.php?id=' . $fila['id_destino'] . '">Editar</a>';
        echo '<a href="eliminar.php?id=' . $fila['id_destino'] . '">Eliminar</a>';
        echo '</td>';
        echo '</tr>';
    }
    echo '</table></div>';
