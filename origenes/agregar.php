...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    elseif (
        ...
        $result = @pg_query_params($conn, 'INSERT INTO Origen (id_origen, ciudad, cobertura) VALUES ($1, $2, $3)', [$id_origen, $ciudad, $cobertura]);
        if ($result) {
...
<form method="post">
    ...
    <input id="id_origen" name="id_origen" type="number" min="1" max="2147483647" step="1" required value="<?= htmlspecialchars(trim((string) ($id_origen))) ?>">
