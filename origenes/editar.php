<?php
    ...
    $query = "SELECT * FROM Origen WHERE id_origen=$1";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($ciudad == "" || ($cobertura != "SI" && $cobertura != "NO")) {
            ...
            $query = "UPDATE Origen SET ciudad=$1, cobertura=$2 WHERE id_origen=$3";
...
<head>
    ...
    <title>Editar origen - Courier</title>
...
<?php
    ...
    echo '    <input id="id_origen" name="id_origen" type="number" min="1" max="2147483647" step="1" readonly required value="' . $id_origen . '">';
