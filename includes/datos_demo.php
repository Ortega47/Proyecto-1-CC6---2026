...
// exactos del modelo (db/courier_bd_simple.sql), para que las vistas no cambien
// cuando estos arreglos se reemplacen por consultas PDO.
//
// TODO(bd): este archivo desaparece cuando consultas.php lea de PostgreSQL.
...
return [
    ...
    // Sin contraseñas: en la demo no se autentica a nadie.
    'usuario' => [
        ['id_usuario' => 1, 'nombre' => 'Ana Pérez',    'usuario' => 'aperez'],
        ['id_usuario' => 2, 'nombre' => 'Luis Morales', 'usuario' => 'lmorales'],
    ],
